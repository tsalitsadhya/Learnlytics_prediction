...
assert_type(
    pu.mapparms(arr_complex, arr_complex), _Tuple2[np.complexfloating[Any, Any]]
)
...
assert_type(
    pu.mapdomain(num_float, seq_num_float, seq_num_complex),
    np.complexfloating[Any, Any],
)
assert_type(
    pu.mapdomain(num_float, seq_num_complex, seq_num_complex),
    np.complexfloating[Any, Any],
)
assert_type(
    pu.mapdomain(num_complex, seq_num_complex, seq_num_complex),
    np.complexfloating[Any, Any],
)
