...
assert_type(
    np.arange(False, True), np.ndarray[tuple[int], np.dtype[np.signedinteger[Any]]]
)
assert_type(np.arange(10), np.ndarray[tuple[int], np.dtype[np.signedinteger[Any]]])
assert_type(
    np.arange(0, 10, step=2), np.ndarray[tuple[int], np.dtype[np.signedinteger[Any]]]
)
assert_type(np.arange(10.0), np.ndarray[tuple[int], np.dtype[np.floating[Any]]])
assert_type(
    np.arange(start=0, stop=10.0), np.ndarray[tuple[int], np.dtype[np.floating[Any]]]
)
assert_type(
