...
class ContinuousDistribution(_ProbabilityDistribution):
    ...
    def _logcdf2_quadrature(self, x, y, **params):
        logres = self._quadrature(
            self._logpdf_dispatch, limits=(x, y), log=True, params=params
        )
        return logres
    ...
    def _logcdf_quadrature(self, x, **params):
        ...
        return self._quadrature(
            self._logpdf_dispatch, limits=(a, x), params=params, log=True
        )
    ...
    def _logccdf_quadrature(self, x, **params):
        ...
        return self._quadrature(
            self._logpdf_dispatch, limits=(x, b), params=params, log=True
        )
